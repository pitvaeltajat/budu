...
export const BUDGET_SECTIONS: BudgetSection[] = [
  ...
  { name: 'Varsinaisen toiminnan kulut', ranges: [[4200, 4399], [4800, 4899]] },
  ...
  { name: 'Kammin tuotot ja kulut', ranges: [[3500, 3599], [4500, 4599]] },
  ...
  { name: 'Satunnaiset erät', ranges: [[7000, 7199], [8825, 8825]] },
